...
module "instances" {
  ...
  public-subnets = module.infr.public_subnet_ids
  private-subnets = module.infr.private_subnet_ids
  public-security-group = module.infr.public_sg_id
  private-security-group = module.infr.private_sg_id
